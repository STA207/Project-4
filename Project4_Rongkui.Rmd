...
The optimal Naive Bayes model outperformed all other models regarding recall of positive cases. Positive cases were the point of focus of this study because of the high cost of false negative errors and the low impact of false positive errors. 
