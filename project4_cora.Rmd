...
All the variables except ‘duration’ were included when building the model.  The confusion matrix for the predictions of the test data set was shown in Table \@ref(tab:rfcm).
