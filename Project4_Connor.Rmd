...
optimal_prob = bayes.predict = predict(nB_opt, testing, type = "raw")



result_full = data.frame(y.act = testing$y, y.pred = result.full$y.pred, y.prob.no = full_prob$no, y.prob.yes = full_prob$yes )

result_optimal = data.frame(y.act = testing$y, y.pred = result.full$y.pred, y.prob.no = full_prob$no, y.prob.yes = full_prob$yes )
