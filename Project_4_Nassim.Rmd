...
The McFadden Score, which is a measure of goodness-of-fit/predictive ability, is 0.23. According to McFadden (1977), values of 0.2 and 0.4 represent an excellent fit. 
...
The AUC value is approximately 0.79. Values above 0.80 indicate that the model does a good job in differentiating between the "no" and "yes" categories of the response variable, and thus our model has good fit according to the AUC measure. 
